...
private[spark] object CoarseGrainedClusterMessages {
  ...
  //marvin
  case class PushBlock(ms:SerializableBuffer) extends CoarseGrainedClusterMessage

  case class PushFinished(tid:Long,executorId:String)
    extends CoarseGrainedClusterMessage

  case class RegisterBlockManagerId(blockManagerId:SerializableBuffer)
